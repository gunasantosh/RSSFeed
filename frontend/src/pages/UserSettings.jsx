...
import {
  ...
  DialogContent, DialogActions, InputLabel, Chip, Snackbar, Alert, FormControl, Select, MenuItem
} from '@mui/material';
import {
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <DialogContent>
        <FormControl fullWidth variant="outlined" sx={{ mt: 2 }}>
          <InputLabel id="topic-select-label">Select New Topic</InputLabel>
          <Select
            labelId="topic-select-label"
            value={newTopic}
            onChange={(e) => setNewTopic(e.target.value)}
            label="Select New Topic"
          >
      ...
      <DialogActions>
        ...
        <Button
          sx={{ backgroundColor: colorPalette.button.background }}
